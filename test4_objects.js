...
{// TEST 4.2
    ...
    function getPropNames(obj) {
        ...
        for (const key in obj) {
            if (obj.hasOwnProperty(key) && key !== 'skip_this_prop') {
                result.push(key);
            }
        }
        return result;
...
{// TEST 4.8
    ...
    function createObjectWithoutProps1and2(inputObj) {
        // Писать код здесь
        const result = Object.assign({}, inputObj);
        delete result.prop1;
        delete result.prop2;
        return result;
    }
...
{// TEST 4.9
    ...
    function copyObject1(inputObj) {
        ...
        const copiedObj = Object.create(Object.getPrototypeOf(inputObj), descriptors);
        return copiedObj;
    }
